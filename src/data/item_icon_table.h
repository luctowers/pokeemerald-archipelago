const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // Badge Items (If ever obtained, should not be added to inventory)
    [ITEM_BADGE_1] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_BADGE_2] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_BADGE_3] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_BADGE_4] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_BADGE_5] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_BADGE_6] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_BADGE_7] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_BADGE_8] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    // ????????
